...
const Hero = () => {
  return (
    <section id="home" className="bg-background text-foreground min-h-screen font-sans relative">
      ...
      <div className="relative min-h-screen flex flex-col px-8 pt-4 md:px-12 md:pt-6">
        ...
        <div className="flex-grow grid md:grid-cols-2 gap-8 items-end pt-16 md:pt-0">
          ...
          <div className="relative order-2 md:order-1 mt-8 md:mt-0 flex items-end justify-center">
            <img src="/bnw-min.png" alt="Portrait of Tharun Arety, a materials engineering professional." className="max-h-[75vh] md:max-h-[90vh] w-auto object-contain" />
          </div>
          ...
          <div className="relative z-10 order-1 md:order-2 self-center md:ml-12">
            <div className="flex flex-col items-center text-center md:items-start md:text-left">
              ...
              <p className="text-lg md:text-xl font-light mt-4 text-primary text-center md:text-left">— I'm Tharun Arety</p>
              <p className="text-sm md:text-base font-light mt-2 text-muted-foreground text-center md:text-left max-w-md">
                Materials Engineering Professional | FEM Simulations | Python Programming
              </p>
              <p className="text-xs md:text-sm font-light mt-2 text-muted-foreground text-center md:text-left max-w-lg">
                Driving Innovation in Materials Science with Data-Driven Simulations
              </p>
