    ...
    <section id="about" className="py-20 md:py-32 px-8 md:px-12 opacity-0 animate-fade-in-up">
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="opacity-0 animate-slide-in-left">
          <h2 className="text-3xl font-light mb-6 opacity-0 animate-fade-in-up">About Tharun Arety</h2>
          <h3 className="text-xl font-medium mb-4 text-primary opacity-0 animate-fade-in-up animation-delay-200">Engineering with Vision, Life with Passion</h3>
          
          <div className="space-y-4 text-muted-foreground leading-relaxed opacity-0 animate-fade-in-up animation-delay-400">
