...
const About = () => {
  return (
    <section id="about" className="py-12 sm:py-16 md:py-20 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12 opacity-0 animate-fade-in-up">
      <div className="container mx-auto">
        <div className="text-center mb-8 sm:mb-12 opacity-0 animate-fade-in-up">
          <h2 className="text-2xl sm:text-3xl font-light mb-4 sm:mb-6">About Tharun Arety</h2>
          <h3 className="text-lg sm:text-xl font-medium text-primary">Engineering with Vision, Life with Passion</h3>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <div className="opacity-0 animate-slide-in-left order-2 lg:order-1">
            <p className="text-muted-foreground leading-relaxed hover:text-foreground transition-colors duration-300 text-sm sm:text-base lg:text-lg text-justify">
          ...
          <div className="flex justify-center opacity-0 animate-slide-in-right animation-delay-200 order-1 lg:order-2 mb-6 lg:mb-0">
            <Card className="w-full max-w-xs sm:max-w-sm border-none shadow-xl overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-500 group">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <div className="flex justify-center opacity-0 animate-slide-in-left animation-delay-400 order-2 lg:order-1 mb-6 lg:mb-0">
            <Card className="w-full max-w-xs sm:max-w-sm border-none shadow-xl overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-500 group">
              <CardContent className="p-0">
                <AspectRatio ratio={4 / 5} className="overflow-hidden rounded-lg">
                  <img 
          ...
          <div className="opacity-0 animate-slide-in-right animation-delay-600 order-1 lg:order-2">
            <h4 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-primary">Beyond the Technical: A World of Exploration and Creation</h4>
            <p className="text-muted-foreground leading-relaxed hover:text-foreground transition-colors duration-300 text-sm sm:text-base lg:text-lg text-justify">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="opacity-0 animate-slide-in-left animation-delay-800 order-2 lg:order-1">
            <h4 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-primary">My Creative Lens: Photography and Filmmaking</h4>
            <p className="text-muted-foreground leading-relaxed hover:text-foreground transition-colors duration-300 text-sm sm:text-base lg:text-lg text-justify">
          ...
          <div className="flex justify-center opacity-0 animate-slide-in-right animation-delay-1000 order-1 lg:order-2 mb-6 lg:mb-0">
            <Card className="w-full max-w-xs sm:max-w-sm border-none shadow-xl overflow-hidden hover:shadow-2xl hover:scale-105 transition-all duration-500 group">
              <CardContent className="p-0">
                <AspectRatio ratio={4 / 5} className="overflow-hidden rounded-lg">
                  <img 
