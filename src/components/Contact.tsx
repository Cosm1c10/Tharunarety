    ...
    <section id="contact" className="py-20 md:py-32 px-8 md:px-12 bg-black">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-light mb-2" id="contact-title">Connect with Tharun</h2>
          <p className="text-lg text-muted-foreground">Let's Collaborate or Create</p>
          <p className="text-sm text-muted-foreground mt-2">Feel free to reach out for professional inquiries, collaborations, or simply to connect!</p>
        </div>
